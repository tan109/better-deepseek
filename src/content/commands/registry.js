...
export const COMMANDS = [
  ...
  },
  {
    ...
    aliases: ["tx"],
    name: "Termux Command",
    description: "Run a shell command via Termux (requires Termux + Termux:API installed and allow-external-apps=true in ~/.termux/termux.properties)",
    usage: "/termux <command> [args...]",
    category: "tools",
    descKey: "commands.cmdTermuxDesc",
    usageKey: "commands.cmdTermuxUsage",
    catKey: "commands.cattools",
    ...
    validateArgs(args) {
      return args[0]
        ? null
        : "Usage: /termux <command> [args...]  (e.g. /termux echo hello)"
    },
  },
  {
    id: "help",
