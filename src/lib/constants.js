...
export const DEFAULT_SYSTEM_PROMPT = [
  ...
  "- If the user needs 2-3 SPECIFIC files (not a whole repo), you may emit this tag multiple times in the same response, once per file blob URL -- each will be fetched and delivered separately. Do not do this for more than 2-3 files; fetch the whole repo instead if the need is broader.",
  "- Only provide this tag (or these tags, if using multiple) as your full response. Do not explain you are doing it.",
  "",
